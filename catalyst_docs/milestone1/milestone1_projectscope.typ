...
- *Deliverable*: *Milestone 2 - Detailed Analysis Report*
  - *Description*: 
        The audit team will prepare a comprehensive report that
    identifies vulnerabilities and areas for improvement within the OpShin language
    codebase.
  - *Key Activities*:
        The audit team will conduct high level analysis by evaluating the functionality of the code 
        using the existing unit tests and also perform manual assessments.
  - *Outcome*: 
        This report will be a foundational document for understanding
...
- *Deliverable*: *Comprehensive Audit Report*
  ...
  - *Outcome*: This report will serve as a crucial resource for the OpShin team, guiding
    them in improving the OpShin language.
...
- *Deliverable*: *Finalized Audit Report and Presentation*
  ...
  - *Key Activities*:
    ...
    - Create a final close-out video to visually represent the project’s achievements
      and key takeaways.
  - *Outcome*: This will enhance community trust and engagement, Letting everyone know 
      what's happening into the auditing process and supporting ongoing improvements in
      the OpShin language.
...
5. *Enhance Quality and Security*: Elevate the quality of smart contracts written in
  OpShin, reinforcing Cardano's reputation as a secure and trustworthy blockchain
  platform.

6. *Support Openness and Teamwork*: Ensure clear communication and cooperation throughout the audit, 
  taking advantage of OpShin's open-source nature to build trust and get the community involved.
...
*Phase 1* : 
  - Establishing communication channels and identifying time points where both teams can allocate more time will support a healthier audit process and this has taken us extra time, offering multiple timeslots for auditor-developer meetings. The official audit process began at the end of October, instead of the originally estimated September deadline for Milestone 1 submission.

*Phase 2* :

  In the weeks 2-3, the audit team will have the Discovery and Planning phase where they will get familiarized with the codebase and project specifications which will cover milestone 2.

*Phase 3* :

  Between the weeks 4-10, the auditors will conduct manual review and will perform the following activities which will cover Milestone 3 and Milestone 4
...
*Phase 4* :
  ...
  The completion of final milestone will take around 1 week wherein the closeout report and final audit report will be published.
...
Key features of Discord for this project:
...
#v(10pt)
To provide evidence of active communication, we have included screenshots of Discord conversations and interactions that demonstrate active participation from both the OpShin team and the audit team. 

// Center-align 
#align(
  left,
)[#box(width: 75%, image("../images/opshin_screenshot1.png"))]

#align(
  left,
)[#box(width: 75%, image("../images/opshin_screenshot2.png"))]

#align(
  left,
)[#box(width: 75%, image("../images/opshin_screenshot3.png"))]
